...
test_that("population estimates are returned for valid explicit geography versions", {
...
test_that("latest version emits an informative message", {
  expect_message(
    get_hb_pop_est(version = "latest", min_year = 2024, max_year = 2024),
    "Using the latest available geography"
  )
  expect_message(
    get_ca_pop_est(version = "latest", min_year = 2024, max_year = 2024),
    "Using the latest available geography"
  )
  expect_message(
    get_hscp_pop_est(version = "latest", min_year = 2024, max_year = 2024),
    "Using the latest available geography"
  )
  expect_message(
    get_iz_pop_est(version = "latest", min_year = 2024, max_year = 2024),
    "Using the latest available geography"
  )
  expect_message(
    get_dz_pop_est(version = "latest", min_year = 2024, max_year = 2024),
    "Using the latest available geography"
  )
})

test_that("year filtering works for supported versions", {
  hb <- get_hb_pop_est(version = "2019", min_year = 2024, max_year = 2024)
  hb_old <- get_hb_pop_est(version = "2006", min_year = 2013, max_year = 2013)

  ca <- get_ca_pop_est(version = "2019", min_year = 2024, max_year = 2024)

  hscp <- get_hscp_pop_est(version = "2019", min_year = 2024, max_year = 2024)

  iz <- get_iz_pop_est(version = "2011", min_year = 2024, max_year = 2024)
  iz_old <- get_iz_pop_est(version = "2001", min_year = 2014, max_year = 2014)

  dz <- get_dz_pop_est(version = "2011", min_year = 2024, max_year = 2024)
  dz_old <- get_dz_pop_est(version = "2001", min_year = 2014, max_year = 2014)
...
test_that("min_year and max_year work independently", {
  hb_min <- get_hb_pop_est(version = "2019", min_year = 2024)
  hb_max <- get_hb_pop_est(version = "2019", max_year = 2024)

  iz_min <- get_iz_pop_est(version = "2011", min_year = 2024)
  iz_max <- get_iz_pop_est(version = "2011", max_year = 2024)

  dz_min <- get_dz_pop_est(version = "2011", min_year = 2024)
  dz_max <- get_dz_pop_est(version = "2011", max_year = 2024)
  ...
  expect_true(all(hb_min$year >= 2024))
  expect_true(all(hb_max$year <= 2024))

  expect_true(all(iz_min$year >= 2024))
  expect_true(all(iz_max$year <= 2024))

  expect_true(all(dz_min$year >= 2024))
  expect_true(all(dz_max$year <= 2024))
})
...
test_that("older high-level pivot_wider options work", {
  ...
  expect_s3_class(hb_old_all, "tbl_df")
